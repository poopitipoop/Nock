...
Submit the three advisories at:
...
maps to its own CVE. File Advisory 1 first; it is the only one that loses funds.

The fourth item is ordinary hardening and belongs in a public issue, not an
advisory.

---
---

# ADVISORY 1 of 3  —  HIGH
